  ...
  const TrailerData:TrailerType[] = [
    {
      ...
      title: '"Fate/Grand Order You’ve Lost Ritsuka Fujimaru" Episode 1 "...On the Reason for Sudden Drowsiness"'
    },
    {
      id:2,
      name:'fujiwaka',
    ...
    },
    {
      ...
      title: 'Rascal Does Not Dream of a Sister Venturing Out | U.S. PREMIERE AT ANIME EXPO'
    },
    {
      id:5,
      name:'Demon Slayer',
      ...
      title: 'Demon Slayer: Kimetsu no Yaiba Hashira Training Arc | Anime Adaptation Official Trailer'
    },
  ]
  ...
  return (
    <div className="py-4">
      ...
      <div className="relative ">
          ...
          slidesPerView={4}
          className={`mySwiper ${ isPlaying? 'invisible h-[260px] sm:h-[330px] md:h-[460px] lg:h-[450px]  xl:h-[560px]': ''}`}
        >
            ...
            <SwiperSlide key={item.id} className={` h-[270px] sm:h-[300px] lg:h-[340px] flex flex-col gap-y-3 `}>
                ...
                >
                  ...
                  '>
                    ...
                    className='bg-no-repeat bg-center bg-cover w-[50px]  h-[50px] xl:opacity-0 group-hover:opacity-100 transition-opacity '></div>
                  </span>
                </div>
                
              <div
                className={`h-[50%] flex  w-full gap-y-2 `}
              >
                <span className=" text-sm lg:text-lg font-bold text-[#444444]">{item.title}</span>
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
